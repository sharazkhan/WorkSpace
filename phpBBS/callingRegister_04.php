...
$customerPhoneNumber = "7760916387";               // Optional parameter
$customerPostcode = "560071";                     // Optional parameter (required if DnBNorDirectPayment)
$customerSocialSecurityNumber = "18106500157";              // Optional parameter 
$customerTown = "bangalore";                     // Optional parameter (required if DnBNorDirectPayment)
